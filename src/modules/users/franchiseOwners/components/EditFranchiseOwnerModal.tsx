// src/modules/users/franchiseOwners/components/EditFranchiseOwnerModal.tsx
import React, { useState, useEffect, useRef } from "react";
import { useAppDispatch } from "../../../../store/hooks";
import { editFranchiseOwner, FranchiseOwner } from "../franchiseOwnersSlice";
import { FiX, FiSave, FiUpload, FiEdit3 } from "react-icons/fi";

export default function EditFranchiseOwnerModal({
  owner,
  onClose,
}: {
  ...
  const [imagePreview, setImagePreview] = useState<string>(owner.profileImage);
  ...
  useEffect(() => {
    ...
    setImagePreview(owner.profileImage);
    setErrors({
      profileImage: "",
      userName: "",
      contactNo: "",
  ...
  const handleSave = () => {
    ...
    dispatch(editFranchiseOwner(form));
    onClose();
  };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-hidden transform transition-all">
        <div className="bg-gradient-to-r from-emerald-600 to-teal-700 text-white px-6 py-4 rounded-t-xl flex justify-between items-center">
          <h2 className="text-xl font-semibold">Edit Franchise Owner</h2>
          <button
            onClick={handleClose}
