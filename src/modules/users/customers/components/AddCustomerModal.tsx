// src/modules/users/customers/components/AddCustomerModal.tsx
import React, { useState } from "react";
import { useAppDispatch } from "../../../../store/hooks";
import { addCustomer, Customer } from "../customersSlice";
...
export default function AddCustomerModal({ onClose }: { onClose: () => void }) {
  ...
  const [form, setForm] = useState({
    ...
    city: "",
    phone: "",
    type: "Direct" as "Direct" | "Referral",
    device: "WEB" as "WEB" | "ANDROID" | "IOS",
