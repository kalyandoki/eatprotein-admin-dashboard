// src/modules/users/team/components/DeleteTeamMemberModal.tsx
import React from "react";
import { useAppDispatch } from "../../../../store/hooks";
import { deleteTeamMember, TeamMember } from "../teamSlice";
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md transform transition-all">
        <div className="bg-red-600 text-white px-6 py-4 rounded-t-xl flex justify-between items-center">
          <h2 className="text-xl font-semibold">Delete Team Member</h2>
