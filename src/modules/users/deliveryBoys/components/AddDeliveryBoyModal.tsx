// src/modules/users/deliveryBoys/components/AddDeliveryBoyModal.tsx
import React, { useState } from "react";
import { useAppDispatch } from "../../../../store/hooks";
import { addDeliveryBoy, DeliveryBoy } from "../deliveryBoysSlice";
...
export default function AddDeliveryBoyModal({
  ...
  const handleSave = () => {
    ...
    const userId =
      form.userId || `DB${1000 + Math.floor(Math.random() * 9000)}`;
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md max-h-[90vh] overflow-hidden transform transition-all">
        <div className="bg-gradient-to-r from-emerald-600 to-teal-700 text-white px-6 py-4 rounded-t-xl flex justify-between items-center">
          <h2 className="text-xl font-semibold">Add New Delivery Boy</h2>
          <button
            onClick={handleClose}
