// src/modules/users/storeAdmins/components/DeleteStoreAdminModal.tsx
import React from "react";
import { useAppDispatch } from "../../../../store/hooks";
import { deleteStoreAdmin, StoreAdmin } from "../storeAdminsSlice";
...
export default function DeleteStoreAdminModal({
  ...
  const handleDelete = () => {
    dispatch(deleteStoreAdmin(admin.id));
    onClose();
  };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md transform transition-all">
        <div className="bg-red-600 text-white px-6 py-4 rounded-t-xl flex justify-between items-center">
          <h2 className="text-xl font-semibold">Delete Store Admin</h2>
