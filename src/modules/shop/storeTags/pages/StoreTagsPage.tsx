...
// // // // import { fetchStoreTags, StoreTag } from "../storeTagsSlice";
// // // // import {
// // // //   FiPlus,
// // // //   FiSearch,
// // // //   FiRefreshCw,
...
// // // //   const { storeTags, status } = useAppSelector((state) => state.storeTags);
...
// // // //   useEffect(() => {
// // // //     if (status === "idle") dispatch(fetchStoreTags());
// // // //   }, [status, dispatch]);
...
// // // //           <div>
// // // //             <h1 className="text-3xl font-bold text-gray-800">Store Tags</h1>
// // // //             <p className="text-gray-600 mt-1">
// // // //               Manage store tags for products content
// // // //             </p>
// // // //           </div>
...
// // // //         {/* Modals */}
// // // //         {showAddModal && (
// // // //           <AddStoreTagModal onClose={() => setShowAddModal(false)} />
// // // //         )}
...
// // import React, { useEffect, useState } from "react";
// // import { useAppDispatch, useAppSelector } from "../../../../store/hooks";
// // import { fetchStoreTags, fetchStores, StoreTag } from "../storeTagsSlice";
// // import {
// //   FiPlus,
// //   FiSearch,
// //   FiRefreshCw,
...
// // import EditStoreTagModal from "../components/EditStoreTagModal";
// // import DeleteStoreTagModal from "../components/DeleteStoreTagModal";
// // import ViewStoreDetailsModal from "../components/ViewStoreDetailsModal";
// // import Pagination from "../../../../components/common/Pagination";
...
// //       tag.store.toLowerCase().includes(search.toLowerCase());
...
// //     let aValue = a[sortField as keyof StoreTag];
// //     let bValue = b[sortField as keyof StoreTag];
...
// //   const indexOfLastItem = currentPage * itemsPerPage;
// //   const indexOfFirstItem = indexOfLastItem - itemsPerPage;
// //   const currentTags = sortedTags.slice(indexOfFirstItem, indexOfLastItem);
...
// //   // Update selectAll state when currentTags changes
// //   useEffect(() => {
// //     const allCurrentIds = currentTags.map((tag) => tag.id);
// //     const allSelected = allCurrentIds.every((id) =>
// //       selectedTagIds.includes(id)
// //     );
// //     setSelectAll(allSelected && allCurrentIds.length > 0);
// //   }, [currentTags, selectedTagIds]);

// //   // Show/hide bulk actions based on selection
// //   useEffect(() => {
// //     setShowBulkActions(selectedTagIds.length > 0);
// //   }, [selectedTagIds]);
...
// //   const handleViewStore = (tag: StoreTag) => {
// //     setSelectedTag(tag);
// //     setShowStoreDetailsModal(true);
// //   };

// //   const handleToggleStatus = (tagId: string) => {
// //     dispatch(toggleTagStatus(tagId));
// //   };

// //   const handleBulkStatusUpdate = (status: "Active" | "Inactive") => {
// //     dispatch(bulkUpdateStatus({ tagIds: selectedTagIds, status }));
// //     setSelectedTagIds([]);
// //     setSelectAll(false);
// //   };
...
// //                         key={tag.id}
// //                         className={`hover:bg-gray-50 transition-colors duration-150 ${
// //                           selectedTagIds.includes(tag.id) ? "bg-emerald-50" : ""
// //                         }`}
// //                       >
// //                         <td className="px-6 py-4 whitespace-nowrap">
// //                           <button
...
// //           />
// //         )}
// //         {showStoreDetailsModal && selectedTag && (
// //           <ViewStoreDetailsModal
// //             store={selectedTag.storeDetails}
// //             onClose={() => {
// //               setSelectedTag(null);
...
// export default function StoreTagsPage() {
//   const dispatch = useAppDispatch();
//   const { storeTags, stores, storeCategories, status } = useAppSelector(
//     (state) => state.storeTags
//   );
//   const [search, setSearch] = useState("");
//   const [selectedTag, setSelectedTag] = useState<StoreTag | null>(null);
...
//       matchesCategory = tag.stores.some((storeId) => {
//         const store = stores.find((s) => s.id === storeId);
...
//       matchesSubcategory = tag.stores.some((storeId) => {
//         const store = stores.find((s) => s.id === storeId);
//         return store?.subcategory === subcategoryFilter;
//       });
//     }
...
//     if (sortField === "stores") {
//       aValue = a.stores.length;
//       bValue = b.stores.length;
//     }
...
//   useEffect(() => {
//     setCurrentPage(1);
//   }, [search, priorityFilter, statusFilter, categoryFilter, subcategoryFilter]);
