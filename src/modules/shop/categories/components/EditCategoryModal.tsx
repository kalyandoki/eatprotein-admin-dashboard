...
//   const [image, setImage] = useState("");
//   const [status, setStatus] = useState("Active");
//   const [items, setItems] = useState("0"); // Added items state
//   const [errors, setErrors] = useState({
//     name: "",
//     description: "",
//     image: "",
//     items: "", // Added items error state
//   });
...
//       setImage(cat.image);
//       setStatus(cat.status);
//       setItems(cat.items.toString()); // Set items from category
...
//         image,
//         status,
//         items: parseInt(items, 10), // Include items in the update
//       })
//     );
//     onClose();
//   };
...
//       setImage(cat.image);
//       setStatus(cat.status);
//       setItems(cat.items.toString()); // Reset items to original value
//     }
//     setErrors({ name: "", description: "", image: "", items: "" });
//     onClose();
//   };
