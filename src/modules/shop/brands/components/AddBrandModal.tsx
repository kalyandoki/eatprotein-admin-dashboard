...
//   const { categories } = useAppSelector((s) => s.categories); // uses your categories slice for dropdown
//   const { subCategories } = useAppSelector((s) => s.subCategories); // uses your subCategories slice
