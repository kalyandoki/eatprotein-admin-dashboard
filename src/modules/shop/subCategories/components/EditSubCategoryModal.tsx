...
// src/modules/subcategories/components/EditSubCategoryModal.tsx
import React, { useState, useEffect } from "react";
import { useAppDispatch } from "../../../../store/hooks";
import { editSubCategory } from "../subCategoriesSlice";
import { FiX } from "react-icons/fi";

const EditSubCategoryModal = ({ open, onClose, data }) => {
  const dispatch = useAppDispatch();
