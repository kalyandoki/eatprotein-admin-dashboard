// src/modules/settlements/dbSettlements/components/AddDBSettlementModal.tsx
import React, { useState } from "react";
import { useAppDispatch } from "../../../../store/hooks";
import { addDBSettlement, DBSettlement } from "../dbSettlementsSlice";
import { FiX, FiSave, FiCalendar, FiDollarSign } from "react-icons/fi";

export default function AddDBSettlementModal({
  onClose,
}: {
  onClose: () => void;
}) {
