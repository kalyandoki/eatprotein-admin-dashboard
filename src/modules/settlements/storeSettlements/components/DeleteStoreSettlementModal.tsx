// src/modules/settlements/storeSettlements/components/DeleteStoreSettlementModal.tsx
...
export default function DeleteStoreSettlementModal({
  settlement,
  onClose,
}: {
  ...
  const handleDelete = () => {
    dispatch(deleteStoreSettlement(settlement.id));
    onClose();
  };
      ...
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md transform transition-all">
        ...
        <div className="p-6">
          ...
          <p className="text-center text-gray-700 mb-6">
            ...
            <span className="font-semibold">{settlement.storeName}</span>?
          </p>
