// // src/modules/coupons/appCoupons/pages/AppCouponsPage.tsx
...
//   FiTag,
// } from "react-icons/fi";
// import AddAppCouponModal from "../components/AddAppCouponModal";
// import EditAppCouponModal from "../components/EditAppCouponModal";
// import DeleteAppCouponModal from "../components/DeleteAppCouponModal";
// import Pagination from "../../../../components/common/Pagination";

// export default function AppCouponsPage() {
//   const dispatch = useAppDispatch();
//   const { coupons, status } = useAppSelector((state) => state.appCoupons);
//   const [search, setSearch] = useState("");
//   const [selectedCoupon, setSelectedCoupon] = useState<AppCoupon | null>(null);
...
//   useEffect(() => {
//     if (status === "idle") dispatch(fetchAppCoupons());
//   }, [status, dispatch]);
...
//   const handleRefresh = () => {
//     dispatch(fetchAppCoupons());
//   };

//   const handleEdit = (coupon: AppCoupon) => {
//     setSelectedCoupon(coupon);
//     setShowEditModal(true);
//   };

//   const handleDelete = (coupon: AppCoupon) => {
//     setSelectedCoupon(coupon);
//     setShowDeleteModal(true);
//   };

//   const handleDuplicate = (couponId: string) => {
//     dispatch(duplicateAppCoupon(couponId));
//   };
...
//                 Manage application coupons and promotional codes
//               </p>
//             </div>
...
//                 App Coupons ({filteredCoupons.length})
//               </h2>
//             </div>
...
//                               className="h-12 w-12 object-cover rounded-lg cursor-pointer transition-all duration-200 group-hover:opacity-75"
...
//         {/* Modals */}
//         {showAddModal && (
//           <AddAppCouponModal onClose={() => setShowAddModal(false)} />
//         )}
...
export default function AppCouponsPage() {
  ...
  const handleImageChange = (couponId: string, imageUrl: string) => {
    dispatch(updateAppCouponImage({ couponId, imageUrl }));
  };
