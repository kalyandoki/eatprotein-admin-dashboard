// // src/modules/coupons/locationCoupons/pages/LocationCouponsPage.tsx
...
//   FiMapPin,
// } from "react-icons/fi";
// import AddLocationCouponModal from "../components/AddLocationCouponModal";
// import EditLocationCouponModal from "../components/EditLocationCouponModal";
// import DeleteLocationCouponModal from "../components/DeleteLocationCouponModal";
// import Pagination from "../../../../components/common/Pagination";

// export default function LocationCouponsPage() {
//   const dispatch = useAppDispatch();
//   const { coupons, status } = useAppSelector((state) => state.locationCoupons);
//   const [search, setSearch] = useState("");
//   const [selectedCoupon, setSelectedCoupon] = useState<LocationCoupon | null>(
//     null
//   );
...
//   useEffect(() => {
//     if (status === "idle") dispatch(fetchLocationCoupons());
//   }, [status, dispatch]);
...
//   const handleRefresh = () => {
//     dispatch(fetchLocationCoupons());
//   };

//   const handleEdit = (coupon: LocationCoupon) => {
//     setSelectedCoupon(coupon);
//     setShowEditModal(true);
//   };

//   const handleDelete = (coupon: LocationCoupon) => {
//     setSelectedCoupon(coupon);
//     setShowDeleteModal(true);
//   };

//   const handleDuplicate = (couponId: string) => {
//     dispatch(duplicateLocationCoupon(couponId));
//   };
...
//                 Manage location-specific coupons and promotional codes
//               </p>
//             </div>
...
//                 Location Coupons ({filteredCoupons.length})
//               </h2>
//             </div>
...
//         {/* Modals */}
//         {showAddModal && (
//           <AddLocationCouponModal onClose={() => setShowAddModal(false)} />
//         )}
//         {showEditModal && selectedCoupon && (
//           <EditLocationCouponModal
...
export default function LocationCouponsPage() {
  ...
  const handleImageChange = (couponId: string, imageUrl: string) => {
    dispatch(updateLocationCouponImage({ couponId, imageUrl }));
  };
