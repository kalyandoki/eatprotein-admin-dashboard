// src/modules/payments/franchise/components/FranchisePaymentsTable.tsx
import React, { useState } from "react";
import { FranchisePayment } from "../franchisePaymentsSlice";
import { FiFilter, FiCalendar, FiDollarSign, FiUser } from "react-icons/fi";
import Pagination from "../../../../components/common/Pagination";

interface FranchisePaymentsTableProps {
...
export default function FranchisePaymentsTable({
  data,
  totals,
  isLoading,
}: FranchisePaymentsTableProps) {
      ...
      <div className="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100">
        <div className="flex justify-between items-center">
          <h2 className="text-lg font-semibold text-gray-800">
            Franchise Payment Records ({data.length})
          </h2>
