// src/modules/masterStore/components/AddProductModal.tsx
...
export default function AddProductModal({ onClose }: AddProductModalProps) {
  ...
  const [nxImagePreview, setNxImagePreview] = useState<string | null>(null);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const image =
      imagePreview || `https://picsum.photos/seed/${seed}/300/300.jpg`;
    const nxImage =
      nxImagePreview || `https://picsum.photos/seed/${seed}-nx/300/300.jpg`;
