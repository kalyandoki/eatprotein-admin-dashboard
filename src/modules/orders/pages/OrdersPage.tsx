...
//       (locationFilter === "" ||
//         order.deliveryAddress.includes(locationFilter)) &&
...
//             <select
//               className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#258440] focus:border-transparent"
//               value={statusFilter}
