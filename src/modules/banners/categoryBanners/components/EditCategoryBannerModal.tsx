// src/modules/banners/categoryBanners/components/EditCategoryBannerModal.tsx
import React, { useState, useEffect, useRef } from "react";
import { useAppDispatch } from "../../../../store/hooks";
import { editCategoryBanner, CategoryBanner } from "../categoryBannersSlice";
import { FiX, FiSave, FiUpload, FiEdit3 } from "react-icons/fi";

export default function EditCategoryBannerModal({
  banner,
  onClose,
}: {
  ...
  const [form, setForm] = useState({
    ...
    selectedStore: banner.selectedStore,
  ...
  const handleSave = () => {
    ...
    dispatch(editCategoryBanner(form));
    onClose();
  };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-hidden transform transition-all">
        <div className="bg-gradient-to-r from-emerald-600 to-teal-700 text-white px-6 py-4 rounded-t-xl flex justify-between items-center">
          <h2 className="text-xl font-semibold">Edit Category Banner</h2>
          <button
            onClick={handleClose}
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-70px)]">
          ...
          <div className="flex justify-end gap-3 px-6 mt-4 py-4 border-t border-gray-200 bg-gray-50">
            <button
              onClick={handleClose}
