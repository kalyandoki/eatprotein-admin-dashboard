// // src/modules/banners/categoryBanners/pages/CategoryBannersPage.tsx
...
//   FiImage,
// } from "react-icons/fi";
// import AddCategoryBannerModal from "../components/AddCategoryBannerModal";
// import EditCategoryBannerModal from "../components/EditCategoryBannerModal";
// import DeleteCategoryBannerModal from "../components/DeleteCategoryBannerModal";
// import Pagination from "../../../../components/common/Pagination";

// export default function CategoryBannersPage() {
//   const dispatch = useAppDispatch();
//   const { banners, bannerTypes, stores, categories, status } = useAppSelector(
//     (state) => state.categoryBanners
//   );
...
//   useEffect(() => {
//     if (status === "idle") dispatch(fetchCategoryBanners());
//   }, [status, dispatch]);
...
//       banner.categoryName.toLowerCase().includes(search.toLowerCase());

//     const matchesBannerType =
//       bannerTypeFilter === "all" || banner.bannerType === bannerTypeFilter;
//     const matchesStore =
//       storeFilter === "all" || banner.selectedStore === storeFilter;
//     const matchesCategory =
//       categoryFilter === "all" || banner.categoryName === categoryFilter;
//     const matchesStatus =
...
//   useEffect(() => {
//     setCurrentPage(1);
//   }, [search, bannerTypeFilter, storeFilter, categoryFilter, statusFilter]);
...
//   const handleDelete = (banner: CategoryBanner) => {
//     setSelectedBanner(banner);
//     setShowDeleteModal(true);
//   };

//   const handleDuplicate = (bannerId: string) => {
//     dispatch(duplicateCategoryBanner(bannerId));
//   };

//   const handleToggleStatus = (bannerId: string) => {
//     dispatch(toggleCategoryBannerStatus(bannerId));
//   };
...
//                 Manage category-specific banners and promotional content
//               </p>
//             </div>
...
//                 <FiImage className="text-red-600 text-xl" />
//               </div>
//             </div>
//           </div>
...
//                 Category Banners ({filteredBanners.length})
//               </h2>
//             </div>
...
//         {/* Modals */}
//         {showAddModal && (
//           <AddCategoryBannerModal onClose={() => setShowAddModal(false)} />
//         )}
//         {showEditModal && selectedBanner && (
//           <EditCategoryBannerModal
...
export default function CategoryBannersPage() {
  ...
  const handleImageChange = (bannerId: string, imageUrl: string) => {
    dispatch(updateCategoryBannerImage({ bannerId, imageUrl }));
  };
