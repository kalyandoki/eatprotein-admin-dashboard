// // src/modules/banners/homeBanners/pages/HomeBannersPage.tsx
...
//   const { banners, bannerTypes, status } = useAppSelector(
...
//   useEffect(() => {
//     if (status === "idle") dispatch(fetchHomeBanners());
//   }, [status, dispatch]);
...
//     return matchesSearch && matchesBannerType && matchesStatus;
//   });
...
//         {/* Modals */}
//         {showAddModal && (
//           <AddBannerModal onClose={() => setShowAddModal(false)} />
//         )}
