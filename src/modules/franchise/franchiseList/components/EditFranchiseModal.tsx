// src/modules/franchise/franchise-list/components/EditFranchiseModal.tsx
import React, { useState, useEffect } from "react";
import { useAppDispatch } from "../../../../store/hooks";
import { editFranchise } from "../franchiseSlice";
...
export default function EditFranchiseModal({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    dispatch(editFranchise(formData));
    onClose();
  };
