// // src/modules/stores/StoreListPage.tsx
// import React, { useEffect, useState } from "react";
// import { useAppDispatch, useAppSelector } from "../../../store/hooks";
// import { useNavigate } from "react-router-dom";
// import { fetchStores, Store, toggleStoreStatus } from "../storeSlice";
// import {
//   FiPlus,
//   FiSearch,
//   FiRefreshCw,
...
//     dispatch(toggleStoreStatus(storeId));
//   };
...
export default function StoreListPage() {
  ...
  const handleLogoChange = (storeId: string, logoUrl: string) => {
    dispatch(updateStoreLogo({ storeId, logoUrl }));
  };
                  ...
                  {currentStores.length === 0 ? (
                    ...
                    currentStores.map((store) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <ImageUpload
                            initialImage={store.logo}
                            onImageChange={(logoUrl) =>
                              handleLogoChange(store.id, logoUrl)
                            }
                            size="sm"
                            className="mx-auto"
                          />
